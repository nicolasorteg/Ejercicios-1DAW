...
public static class FunkosFactory {
    /// <summary>
    /// Inicializar 15 Funkos para comenzar la
    /// ejecución con datos de prueba
    /// </summary>
    /// <returns>Lista de Funkos</returns>
    public static FunkoPop[] DemoFunkos() {
        return [
            new FunkoPop { Id = 1, Nombre = "Iron Man", Categoria = FunkoPop.Tipo.Superheroe, Precio = 25.50m },
            new FunkoPop { Id = 2, Nombre = "Spider-Man (Clásico)", Categoria = FunkoPop.Tipo.Superheroe, Precio = 30.00m },
            ...
            new FunkoPop { Id = 7, Nombre = "Capitán América", Categoria = FunkoPop.Tipo.Superheroe, Precio = 28.75m },
            ...
            new FunkoPop { Id = 10, Nombre = "Black Widow", Categoria = FunkoPop.Tipo.Superheroe, Precio = 17.00m },
            ...
            new FunkoPop { Id = 13, Nombre = "Thor (Ragnarok)", Categoria = FunkoPop.Tipo.Superheroe, Precio = 23.00m },
